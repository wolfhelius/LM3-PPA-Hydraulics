...
interface send_tile_data
   module procedure send_tile_data_0d_real
   module procedure send_tile_data_0d_int
   module procedure send_tile_data_1d_real
   module procedure send_tile_data_1d_int
end interface
...
! ============================================================================
subroutine send_tile_data_0d_real(id, x, buffer)
...
end subroutine send_tile_data_0d_real

! ============================================================================
subroutine send_tile_data_0d_int(id, x, buffer)
  integer, intent(in) :: id
  integer, intent(in) :: x
  type(diag_buff_type), intent(inout) :: buffer ! buffer is unused in this version
...
end subroutine send_tile_data_0d_int

! ============================================================================
subroutine send_tile_data_1d_real(id, x, buffer)
  integer, intent(in) :: id
  real   , intent(in) :: x(:)
  type(diag_buff_type), intent(inout) :: buffer ! buffer is unused in this version
  ...
  call get_date(lnd%time, year, month, day, hour, minute, second)
  write(id,diag_format) year,month,day,hour,minute,second,x
end subroutine send_tile_data_1d_real

! ============================================================================
subroutine send_tile_data_1d_int(id, x, buffer)
  integer, intent(in) :: id
  integer, intent(in) :: x(:)
  type(diag_buff_type), intent(inout) :: buffer ! buffer is unused in this version
  ...
  call get_date(lnd%time, year, month, day, hour, minute, second)
  write(id,diag_format) year,month,day,hour,minute,second,x
end subroutine send_tile_data_1d_int
