...
character(len=*), parameter :: &
     ...
     version     = '$Id: snow_tile.F90,v 1.1.2.5 2012/06/19 18:34:54 pjp Exp $' ,&
...
subroutine read_snow_data_namelist(snow_num_l, snow_dz, snow_mc_fict)
  ...
  do 
     read (nml_unit, nml=snow_data_nml, iostat=io, end=10)
     if (check_nml_error (io, 'snow_data_nml')==0) exit ! from loop
  enddo
10  close (nml_unit)
  write(logunit, nml=snow_data_nml)
