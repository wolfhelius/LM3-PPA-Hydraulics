...
! </PUBLIC>
 ...
 use        utilities_mod,  only: logunit, get_unit, mpp_error, FATAL, error_mesg, &
                                  check_nml_error
...
!  cvs version and tag name
 ...
 character(len=128) :: version = '$Id: sat_vapor_pres.F90,v 1.1.2.6 2011/03/28 16:24:15 pjp Exp $'
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     call error_mesg('lookup_es',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     call error_mesg('lookup_es',err_msg_tmp,FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_es2',err_msg_local,FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_es2',err_msg_tmp, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_es3',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_es3',err_msg_tmp, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_des',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_des',err_msg_tmp, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_des2',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_des2',err_msg_tmp, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_des3',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_des3',err_msg_tmp, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_es2_des2',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_local
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_local,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('lookup_es3_des3',err_msg_local, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('compute_qs',err_msg_tmp, FATAL)
   endif
...
! </SUBROUTINE>
 ...
 character(len=128) :: err_msg_tmp
   ...
   if ( nbad == 0 ) then
     ...
     if(show_all_bad_values) call show_all_bad ( temp )
     write(err_msg_tmp,'(a47,i7)') 'saturation vapor pressure table overflow, nbad=', nbad
     call error_mesg('compute_mrs',err_msg_tmp, FATAL)
   endif
...
!---- read namelist input ----
  ...
  do 
     read (nml_unit, nml=sat_vapor_pres_nml, iostat=io, end=10)
     if (check_nml_error (io, 'sat_vapor_pres_nml')==0) exit ! from loop
  enddo
10  close (nml_unit)

! write version number and namelist to log file
  write (logunit,'(/,80("="),/(a))') trim(version), trim(tagname)
  write (logunit, nml=sat_vapor_pres_nml)
  ...
  if ( err_msg_local == '' ) then
     ...
     call error_mesg('sat_vapor_pres_init',err_msg_local, FATAL)
  endif
...
!#######################################################################
 ...
 integer :: i
   ...
   write(outunit,*) 'Bad temperatures (dimension 1): ', (check_1d(temp(i:i)),i=1,size(temp,1))
...
!--------------------------------------------------------------
 ...
 integer :: i, j
   ...
   write(outunit,*) 'Bad temperatures (dimension 1): ', (check_1d(temp(i,:)),i=1,size(temp,1))
   write(outunit,*) 'Bad temperatures (dimension 2): ', (check_1d(temp(:,j)),j=1,size(temp,2))
...
!--------------------------------------------------------------
 ...
 integer :: i, j, k
   ...
   write(outunit,*) 'Bad temperatures (dimension 1): ', (check_2d(temp(i,:,:)),i=1,size(temp,1))
   write(outunit,*) 'Bad temperatures (dimension 2): ', (check_2d(temp(:,j,:)),j=1,size(temp,2))
   write(outunit,*) 'Bad temperatures (dimension 3): ', (check_2d(temp(:,:,k)),k=1,size(temp,3))
...
subroutine show_all_bad_0d ( temp )
 ...
 if (ind < 0 .or. ind > nlim) then
   write(outunit,'(a,e10.3)') 'Bad temperature=',temp
 endif
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp)
   ind = int(dtinv*(temp(i)-tmin+teps))
   if (ind < 0 .or. ind > nlim) then
     write(outunit,'(a,e10.3,a,i4)') 'Bad temperature=',temp(i),'  at i=',i
   endif
 enddo
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp,1)
   ...
   if (ind < 0 .or. ind > nlim) then
     write(outunit,'(a,e10.3,a,i4,a,i4)') 'Bad temperature=',temp(i,j),'  at i=',i,' j=',j
   endif
 enddo
 enddo
...
!--------------------------------------------------------------
 ...
 do i=1,size(temp,1)
   ...
   if (ind < 0 .or. ind > nlim) then
     write(outunit,'(a,e10.3,a,i4,a,i4,a,i4)') 'Bad temperature=',temp(i,j,k),'  at i=',i,' j=',j,' k=',k
   endif
 enddo
 enddo
 enddo
