...
use utilities_mod   ,  only: logunit, get_unit, error_mesg, FATAL, NOTE, WARNING, &
                             check_nml_error
...
character(len=128)  :: version =  '$Id: astronomy.F90,v 1.1.2.5 2011/03/28 16:24:15 pjp Exp $'
...
!  local variables:
      ...
      integer :: nml_unit, io, seconds, days, jd, id
...
!-----------------------------------------------------------------------
      ...
      do 
         read (nml_unit, nml=astronomy_nml, iostat=io, end=10)
         if (check_nml_error (io, 'astronomy_nml')==0) exit ! from loop
      enddo
10    close (nml_unit)
...
!---------------------------------------------------------------------
      ...
      write (logunit, nml=astronomy_nml)
!--------------------------------------------------------------------
