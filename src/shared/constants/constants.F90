...
character(len=128) :: version='$Id: constants.F90,v 1.1.2.1 2011/03/07 17:45:21 pjp Exp $'
...
!-----------------------------------------------------------------------
! version and tagname published so that they can be written
! to logfile.out by some module that has executable code.
